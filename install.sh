...
declare -A pkg_latest=(
	[wps]='https://wps-linux-personal.wpscdn.cn/wps/download/ep/Linux2023/25882/wps-office_12.1.2.25882.AK.preread.sw.Personal_662820_amd64.deb?t=1776157825&k=8728a64790b97b384936e9e898ba9ea1'
...
[go]='安装 go'
[tg]='安装 telegram, 安装包./TG.tar.xz, 优先用本地缓存'
...
function help() {
	echo "$0 <function_name> [function_name [function_name]]"
	echo ""
